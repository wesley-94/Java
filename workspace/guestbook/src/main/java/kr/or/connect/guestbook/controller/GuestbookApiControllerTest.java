...
import static org.springframework.test.web.servlet.reuslt.MockMvcResultMatchers.status;

@RunWith(SpringJUnit4ClassRunner.class)
@WebAppConfiguration
@ContextConfiguration(classe = {WebMvcContextConfiguration.class, ApplicationConfig.class})
